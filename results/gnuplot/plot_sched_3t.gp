...
set terminal postscript eps enhanced color 'Helvetica' 14 size 14cm,3.75cm
set output 'plot_sched_lp_3t.eps'
...
plot "sched_3t.txt" using 1:($3/1000) ls 1 title "Preemptive (avg)" with lines,\
"sched_3t.txt" using 1:($4/1000) ls 2 title "Preemptive (max)" with lines,\
"sched_3t.txt" using 1:($6/1000) ls 3 title "Limited Preemptive (avg)" with lines,\
"sched_3t.txt" using 1:($7/1000) ls 4 title "Limited Preemptive (max)" with lines,\
"sched_3t.txt" using 1:($9/1000) ls 5 title "Non-preemptive (avg)" with lines,\
"sched_3t.txt" using 1:($10/1000) ls 6 title "Non-preemptive (max)" with lines;
